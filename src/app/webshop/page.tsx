...
export default function WebshopPage() {
  ...
  const availableBeers = beers.filter((b) => hasAvailableVariants(b));
  const upsellBeers = availableBeers;
          ...
          <section className="webshop-grid">
            <div className="webshop-grid-inner">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  style={{ height: 420, border: "3px solid var(--dark)", background: "var(--warm-white)", opacity: 0.35 }}
                />
              ))}
            </div>
          </section>
    ...
    <>
      ...
      <main>
        ...
        {showShop ? (
          <section className="webshop-grid">
            <div className="webshop-grid-inner">
              <HomepageBeers beers={availableBeers} />
            </div>
                      ...
                      <div className="upsell-block">
                        ...
                        <div className="upsell-grid">
                          {upsellBeers.map((beer) => {
                            const av = beer.variants.filter((v) => v.isAvailable && v.stock > 0);
